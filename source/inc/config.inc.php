<?php
	...
	/// MySQL Settings ///
	define('DB_NAME', 'cashback_1');	// MySQL database name
	define('DB_USER', 'cashback_user');			// MySQL database user
	define('DB_PASSWORD', '1Digit@lMint1220');		// MySQL database password
