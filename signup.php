	...
	if (isset($_POST['action']) && $_POST['action'] == "signup")
	{
		...
		if (count($errs) == 0)
		{
				...
				{			
					...
					header("Location: https://cashbackholic.ro/activate.php?msg=1");
					exit();
				}
				else
				{
					...
					else
					{
						...
						$redirect_url = SITE_URL."myaccount.php?msg=welcome";
					}
...
?>
	...
	<div class="col-md-6 col-md-offset-3">
			...
			<p class="pull-right" style="padding-top: 15px"><?php echo CBE1_SIGNUP_MEMBER; ?> <a href="<?php echo SITE_URL; ?>login.php"><?php echo CBE1_LOGIN_TITLE; ?></a></p>
